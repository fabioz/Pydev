...
@echo x:
@echo cd x:\pydev
@echo C:\bin\maven-3.2.1\bin\mvn -o tycho-versions:set-version -Dtycho.localArtifacts=ignore -DnewVersion=3.4.0-SNAPSHOT
...
set ECLIPSE_CLEAN=C:\bin\eclipse432_x64_clean
