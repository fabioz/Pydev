...
set ECLIPSE_CLEAN=C:\bin\eclipse44_2_final
set LAUNCHER_PLUGIN=org.eclipse.equinox.launcher_1.3.0.v20140415-2008
set BUILDER_PLUGIN=org.eclipse.pde.build_3.9.0.v20140415-2029
