...
public class PyASTChanger extends AbstractPyASTChanger {
     ...
     * @param attr the attribute (that must be an array of stmtType) where the change will be added
     * @param pos the position of the array where the change should be added
