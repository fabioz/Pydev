...
public class ClassDefVisitor extends AbstractContextVisitor<ClassDefAdapter> {
	...
	@Override
	protected ClassDefAdapter createAdapter(AbstractScopeNode<?> parent, SimpleNode node) {
