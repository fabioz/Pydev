...
__revision__ = '$Id: table.py,v 1.5 2005-04-19 14:39:09 fabioz Exp $'
...
class Table:
    ...
    def create_rows(self, row_names):
        ...
        for row_name in row_names:
            self.data.append([0]*len(self.col_names))
    ...
    def insert_row(self, index, row_data, row_name):
    ...
    def transpose(self):
        """Keeps the self object intact, and returns the transpoed (rotated)
        table.
        """
        transposed = Table()
...
class DocbookRenderer(TableCellRenderer):
    ...
    def __init__(self, **properties):
        TableCellRenderer.__init__(self, **properties)
