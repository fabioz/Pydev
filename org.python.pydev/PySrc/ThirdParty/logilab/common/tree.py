...
__revision__ = "$Id: tree.py,v 1.3 2005-01-21 17:42:04 fabioz Exp $"
...
class Node :
    ...
    def leafs(self):
        """
        return a list with all the leaf nodes descendant from this node
        """
        leafs = []
        if self.children:
            for child in self.children:
