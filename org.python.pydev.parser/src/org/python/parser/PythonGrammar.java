...
public class PythonGrammar/*@bgen(jjtree)*/implements PythonGrammarTreeConstants, PythonGrammarConstants {/*@bgen(jjtree)*/
  protected JJTPythonGrammarState jjtree = new JJTPythonGrammarState();
    ...
    /**
     * This is sa that we add the String with the beginLine and beginColumn
     */
...
//small_stmt: expr_stmt | print_stmt  | del_stmt | pass_stmt | flow_stmt | import_stmt | global_stmt | exec_stmt | assert_stmt
  final public void small_stmt() throws ParseException {
    ...
    case PASS:
      pass_stmt();
                 ((SimpleNode)jjtree.peekNode()).addSpecial("pass",false);
      break;
    case BREAK:
    case CONTINUE:
    case RETURN:
  ...
  final public void flow_stmt() throws ParseException {
    ...
    case BREAK:
      ...
      try {
              ...
              jjtc001 = false;
              jjtreeCloseNodeScope(jjtn001);
             ((SimpleNode)jjtree.peekNode()).addSpecial("break",true);
      } finally {
              if (jjtc001) {
                jjtree.closeNodeScope(jjtn001,  0);
                jjtreeCloseNodeScope(jjtn001);
    ...
    case CONTINUE:
      ...
      try {
                  ...
                  jjtc002 = false;
                  jjtreeCloseNodeScope(jjtn002);
                 ((SimpleNode)jjtree.peekNode()).addSpecial("continue",true);
      } finally {
                  if (jjtc002) {
                    jjtree.closeNodeScope(jjtn002,  0);
                    jjtreeCloseNodeScope(jjtn002);
  ...
  jjtreeOpenNodeScope(jjtn000);
    try {
      jj_consume_token(RETURN);
            this.addSpecialToken("return ",STRATEGY_BEFORE_NEXT);
      switch ((jj_ntk==-1)?jj_ntk():jj_ntk) {
      case LPAREN:
      case LBRACE:
      case LBRACKET:
  ...
  jjtreeOpenNodeScope(jjtn000);
    try {
      jj_consume_token(YIELD);
          this.addSpecialToken("yield ",STRATEGY_BEFORE_NEXT);
      SmartTestList();
    } catch (Throwable jjte000) {
    if (jjtc000) {
      jjtree.clearNodeScope(jjtn000);
  ...
  jjtreeOpenNodeScope(jjtn000);
    try {
      jj_consume_token(FOR);
          ...
          jjtc000 = false;
          jjtreeCloseNodeScope(jjtn000);
         this.addSpecialToken("for ",STRATEGY_BEFORE_NEXT);
    } finally {
    if (jjtc000) {
      jjtree.closeNodeScope(jjtn000, true);
      jjtreeCloseNodeScope(jjtn000);
