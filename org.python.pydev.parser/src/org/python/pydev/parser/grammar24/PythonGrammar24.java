...
public class PythonGrammar24 implements PythonGrammarTreeConstants24, PythonGrammarConstants24 {/*@bgen(jjtree)*/
  protected JJTPythonGrammarState24 jjtree = new JJTPythonGrammarState24();
   ...
   public PythonGrammar24(PythonGrammarTokenManager24 tm,
                        IParserHost host)
   {
        this(tm);
        hostLiteralMkr = host;
...
//           ['else' ':' suite] | 'try' ':' suite 'finally' ':' suite)
  final public void try_stmt() throws ParseException {
    ...
    switch ((jj_ntk==-1)?jj_ntk():jj_ntk) {
    case EXCEPT:
      SimpleNode jjtn001 = (SimpleNode)jjtree.builder.openNode( JJTTRY_STMT);
      boolean jjtc001 = true;
      jjtree.openNodeScope(jjtn001);
      jjtreeOpenNodeScope(jjtn001);
      try {
    ...
    case FINALLY:
      begin_finally_stmt();
                             SimpleNode jjtn002 = (SimpleNode)jjtree.builder.openNode( JJTTRYFINALLY_STMT);
                             boolean jjtc002 = true;
                             jjtree.openNodeScope(jjtn002);
                             jjtreeOpenNodeScope(jjtn002);
      try {
 ...
 /*@bgen(jjtree) Name */
  ...
  final public Token AnyName() throws ParseException {
    ...
    case ASSERT:
      ...
      break;
    case AS:
      SimpleNode jjtn031 = (SimpleNode)jjtree.builder.openNode( JJTNAME);
  ...
  public PythonGrammarTokenManager24 token_source;
  ...
  public PythonGrammar24(CharStream stream) {
    token_source = new PythonGrammarTokenManager24(stream);
    token = new Token();
    jj_ntk = -1;
    jj_gen = 0;
  ...
  public void ReInit(PythonGrammarTokenManager24 tm) {
    token_source = tm;
    token = new Token();
    jj_ntk = -1;
    jjtree.reset();
