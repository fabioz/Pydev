...
public class PythonGrammarTokenManager24 implements PythonGrammarConstants24
{
...
public PythonGrammarTokenManager24(CharStream stream){
   input_stream = stream;
}
public PythonGrammarTokenManager24(CharStream stream, int lexState){
   this(stream);
   SwitchTo(lexState);
}
