...
public class argumentsType extends SimpleNode {
    ...
    public void pickle(DataOutputStream ostream) throws IOException {
        ...
        pickleThis(this.kwonlyargs, ostream);
        pickleThis(this.kw_defaults, ostream);
        pickleThis(this.annotation, ostream);
        pickleThis(this.varargannotation, ostream);
        pickleThis(this.kwargannotation, ostream);
        pickleThis(this.kwonlyargannotation, ostream);
    }
