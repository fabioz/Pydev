...
public class PythonGrammar/*@bgen(jjtree)*/implements PythonGrammarTreeConstants, PythonGrammarConstants {/*@bgen(jjtree)*/
    public JJTPythonGrammarState jjtree = new JJTPythonGrammarState();
   ...
   public PythonGrammar(CharStream stream,IParserHost host, int grammarVersion) {
       this(stream);
       hostLiteralMkr = host;
  ...
  final public void try_stmt() throws ParseException {
    ...
    case EXCEPT:
      ...
      case ELSE:
        begin_try_else_stmt();
        suite();
                                                         SimpleNode jjtn001 = (SimpleNode)SimpleNode.jjtCreate(this, JJTTRYELSE_STMT);
                                                         boolean jjtc001 = true;
                                                         jjtree.openNodeScope(jjtn001);
                                                         jjtreeOpenNodeScope(jjtn001);
        try {
      ...
      default:
        ...
        ;
                          ...
                          SimpleNode jjtn003 = (SimpleNode)SimpleNode.jjtCreate(this, JJTTRY_STMT);
                          boolean jjtc003 = true;
                          jjtree.openNodeScope(jjtn003);
                          jjtreeOpenNodeScope(jjtn003);
      try {
        ...
        case FINALLY:
          begin_finally_stmt();
          suite();
                                                         SimpleNode jjtn002 = (SimpleNode)SimpleNode.jjtCreate(this, JJTTRYFINALLY_OUTER_STMT);
                                                         boolean jjtc002 = true;
                                                         jjtree.openNodeScope(jjtn002);
                                                         jjtreeOpenNodeScope(jjtn002);
          try {
    ...
    case FINALLY:
      begin_finally_stmt();
                                         SimpleNode jjtn004 = (SimpleNode)SimpleNode.jjtCreate(this, JJTTRYFINALLY_STMT);
                                         boolean jjtc004 = true;
                                         jjtree.openNodeScope(jjtn004);
                                         jjtreeOpenNodeScope(jjtn004);
      try {
...
//with_stmt: 'with' test [ with_var ] ':' suite
  ...
  SimpleNode jjtn000 = (SimpleNode)SimpleNode.jjtCreate(this, JJTWITH_STMT);
  boolean jjtc000 = true;
  jjtree.openNodeScope(jjtn000);
  jjtreeOpenNodeScope(jjtn000);
    try {
...
//with_var: 'as' expr
  ...
  SimpleNode jjtn000 = (SimpleNode)SimpleNode.jjtCreate(this, JJTWITH_VAR);
  boolean jjtc000 = true;
  jjtree.openNodeScope(jjtn000);
  jjtreeOpenNodeScope(jjtn000);
    try {
...
//old_lambdef: 'lambda' [varargslist] ':' old_test
  final public void old_lambdef() throws ParseException {
                    ...
                    SimpleNode jjtn000 = (SimpleNode)SimpleNode.jjtCreate(this, JJTOLD_LAMBDEF);
                    boolean jjtc000 = true;
                    jjtree.openNodeScope(jjtn000);
...
//test: or_test ['if' or_test 'else' test] | lambdef
  ...
  final public void if_exp() throws ParseException {
               /*@bgen(jjtree) if_exp */
  SimpleNode jjtn000 = (SimpleNode)SimpleNode.jjtCreate(this, JJTIF_EXP);
  boolean jjtc000 = true;
  jjtree.openNodeScope(jjtn000);
  jjtreeOpenNodeScope(jjtn000);
    try {
