...
public interface IInterpreterObserver {
     ...
     * @param monitor
     */
    void notifyProjectPythonpathRestored(IPythonNature nature, IProgressMonitor monitor);
     ...
     * @param monitor
     */
    void notifyNatureRecreated(IPythonNature nature, IProgressMonitor monitor);
