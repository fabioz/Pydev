...
public class PythonPartitions {
    ...
    static {
        ...
        STRING_PROCESSOR_PARTITIONS.add(IPythonPartitions.PY_MULTILINE_FSTRING1);
        STRING_PROCESSOR_PARTITIONS.add(IPythonPartitions.PY_MULTILINE_FSTRING2);
        STRING_PROCESSOR_PARTITIONS.add(IPythonPartitions.PY_SINGLELINE_FSTRING1);
        STRING_PROCESSOR_PARTITIONS.add(IPythonPartitions.PY_SINGLELINE_FSTRING2);
    }
}
