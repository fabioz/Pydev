...
public interface ICompletionState extends ICompletionCache, IModuleRequestState {
    ...
    public enum LookingFor {
        LOOKING_FOR_INSTANCE_UNDEFINED, LOOKING_FOR_INSTANCED_VARIABLE, LOOKING_FOR_UNBOUND_VARIABLE, LOOKING_FOR_CLASSMETHOD_VARIABLE, LOOKING_FOR_ASSIGN, LOOKING_FOR_WITH_CTX
    };
