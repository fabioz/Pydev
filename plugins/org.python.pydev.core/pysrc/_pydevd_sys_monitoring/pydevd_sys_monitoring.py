...
#
# License: EPL with additional restriction:
#
# This file may not be currently distributed, used or have any portion of it
# copied in any program which may be considered a competitor to PyDev/LiClipse
# unless such a written agreement with Brainwy Software Ltda to remove this
...
def _jump_event(code, _from_offset, _to_offset):
    frame = _getframe(1)
    return _line_event(code, frame.f_lineno, frame)


def _line_event(code, line, frame=None):
