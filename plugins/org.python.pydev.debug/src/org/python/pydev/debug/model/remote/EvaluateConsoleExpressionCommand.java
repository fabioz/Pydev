...
public class EvaluateConsoleExpressionCommand extends AbstractDebuggerCommand {
	...
	public EvaluateConsoleExpressionCommand(AbstractDebugTarget debugger,
			String locator, ICommandResponseListener responseListener) {
		super(debugger);
	...
	public void processOKResponse(int cmdCode, String payload) {
		...
		if (responseCode == CMD_EVALUATE_CONSOLE_EXPRESSION)
			...
			PydevDebugPlugin.log(IStatus.ERROR,
					"Unexpected response to GetTaskletCallStackCommand", null);
		}
	}
