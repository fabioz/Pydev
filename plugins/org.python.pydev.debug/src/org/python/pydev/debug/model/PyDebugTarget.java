 ...
 * 
 * It deals with events from RemoteDebugger. Breakpoint updating.
 */
public class PyDebugTarget extends AbstractDebugTarget {
	...
	public PyDebugTarget(ILaunch launch, IProcess process, IPath[] file,
			RemoteDebugger debugger, IProject project) {
		this.launch = launch;
		...
		// we have to know when we get removed, so that we can shut off the
		// debugger
