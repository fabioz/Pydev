...
public class PyParserWithoutTree extends TestCase{
	...
	public void testGenerateParseError() throws Exception {
		...
		Tuple<SimpleNode, Throwable> tuple = PyParser.reparseDocument(new PyParser.ParserInfo(
				new Document(contents), grammarProvider, false));
		
		assertTrue("Found: "+tuple.o2, tuple.o2 instanceof ParseException);
		
		tuple = PyParser.reparseDocument(new PyParser.ParserInfo(
				new Document("a = 10"), grammarProvider, false));
