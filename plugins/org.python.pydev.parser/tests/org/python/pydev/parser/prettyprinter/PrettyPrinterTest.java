...
public class PrettyPrinterTest extends AbstractPrettyPrinterTestBase {
    ...
    public void testNewSetConstruct() throws Throwable {
        final String s = "" + "mutable_set = {1,2,3,4,5}\n" + "";
    ...
    public void testNewSetCompConstruct() throws Throwable {
        final String s = "" + "mutable_set = {x for x in xrange(10)}\n" + "";
    ...
    public void testEllipsis2() throws Throwable {
        final String s = "" + "class Bar(object):\n" + "    ...\n" + "...\n" + "";
    ...
    public void testEllipsis3() throws Throwable {
        final String s = "" + "from ... import foo\n" + "class Bar(object):\n" + "    ...\n" + "...\n" + "";
    ...
    public void testNewIf() throws Throwable {
        final String s = "" + "j = stop if (arg in gets) else start\n" + "";

        //Without specials, we don't know about the parenthesis.
        final String v2 = "" + "j = stop if arg in gets else start\n" + "";
        checkWithAllGrammars(new ICallback<Boolean, Integer>() {
    ...
    public void testMethodDef() throws Throwable {
        final String s = "" + "def _dump_registry(cls,file=None):\n" + "    pass\n" + "";
        checkWithAllGrammars(new ICallback<Boolean, Integer>() {
    ...
    public void testLinesAfterMethod() throws Throwable {
        ...
        final String s = "" + "def method():\n" + "    pass\n" + "a = 10" + "";

        final String expected = "" + "def method():\n" + "    pass\n" + "\n" + "a = 10\n" + "";
        checkWithAllGrammars(new ICallback<Boolean, Integer>() {
    ...
    public void testExec2() throws Throwable {
        final String s = "" + "exec ('a=1')\n" + "";

        final String v2 = "" + "exec 'a=1'\n" + "";
    ...
    public void testDictComp() throws Throwable {
        final String s = "" + "d = {i:i * 2 for i in range(3)}\n" + "";
    ...
    public void testMethodDef4() throws Throwable {
        final String s = "" + "def _set_stopinfo(stoplineno=-1):\n" + "    pass\n" + "";
        checkWithAllGrammars(new ICallback<Boolean, Integer>() {
    ...
    public void testMethodDef2() throws Throwable {
        final String s = "" + "def _set_stopinfo(self,stopframe,returnframe,stoplineno=-1):\n"
                + "    if not sys.args[:1]:\n" + "        pass\n" + "";
        checkWithAllGrammars(new ICallback<Boolean, Integer>() {
    ...
    public void testMethodDef5() throws Throwable {
        final String s = "" + "def _set_stopinfo(stoplineno=not x[-1]):\n" + "    if not sys.args[:1]:\n"
                + "        pass\n" + "";
        checkWithAllGrammars(new ICallback<Boolean, Integer>() {
    ...
    public void testMethodDef3() throws Throwable {
        final String s = "" + "def Bastion(object,filter=lambda kk:kk[:1] != '_',name=None,bastionclass=Foo):\n"
                + "    pass\n" + "";
        checkWithAllGrammars(new ICallback<Boolean, Integer>() {
    ...
    public void testListComp6() throws Throwable {
        final String s = "" + "start,stop = (int(x) for x in spec.split('-'))\n" + "";
        checkWithAllGrammars(new ICallback<Boolean, Integer>() {
    ...
    public void testFuncCallWithListComp() throws Throwable {
        final String s = "" + "any(cls.__subclasscheck__(c) for c in [subclass,subtype])\n" + "";
        checkWithAllGrammars(new ICallback<Boolean, Integer>() {
    ...
    public void testComment5() throws Exception {
        String s = "" + "class CoolApproach(object):\n" + "    # this tests also a tuple \"special case\"\n"
                + "    def foodeco(**arg5):\n" + "        pass\n" + "";
        String v3 = "" + "class CoolApproach(object):# this tests also a tuple \"special case\"\n"
                + "    def foodeco(**arg5):\n" + "        pass\n" + "";
        checkPrettyPrintEqual(s, s, s, v3);
    ...
    public void testComments6() throws Exception {
        String s = "" + "class FooApproach(CoolApproach):\n"
                + "    def __init__(self,arg_1,(arg_2,arg_3),*arg_4,**arg_5):\n"
    ...
    public void testImport6() throws Exception {
        ...
        String v3 = "" + "from hashlib import md5#foo\n" + "new = md5\n" + "";
        checkPrettyPrintEqual(s, s, s, v3);
    }

    public void testKwArgs2() throws Exception {
        String s = "" + "HTTPS(host,None,**(x509 or {}))\n" + "";
        checkPrettyPrintEqual(s);
    }
    ...
    public void testLambda3() throws Exception {
        String s = "" + "lambda a:(1 + 2)\n" + "";

        String v2 = "" + "lambda a:1 + 2\n" + "";
        checkPrettyPrintEqual(s, s, v2);
    }

    public void testLambda4() throws Exception {
        String s = "" + "lambda d='':digestmod.new(d)\n" + "";
        checkPrettyPrintEqual(s);
    }
    ...
    public void testListComp4() throws Exception {
        String s = "" + "print [e for e in group if e[0] in a]\n" + "";
        checkPrettyPrintEqual(s);
    }
    ...
    public void testStr() throws Exception {
        String s = "" + "a = (r\"a\"#comm1\n" + "    r'\"b\"'#comm2\n" + ")\n" + "";
        String v2 = "" + "a = (r\"a\"#comm1\n" + "    r'\"b\"'#comm2\n" + ")\n" + "";
    ...
    public void testLambda() throws Exception {
        String s = "" + "print lambda n:n\n" + "";
        checkPrettyPrintEqual(s);
    }

    public void testListComp3() throws Exception {
        String s = "" + "print [s2 for s1 in b for s2 in a]\n" + "";
        checkPrettyPrintEqual(s);
    }
    ...
    public void testListComp2() throws Exception {
        String s = "" + "for (raw,cooked) in foo:\n" + "    pass\n" + "";
        String v2 = "" + "for raw,cooked in foo:\n" + "    pass\n" + "";
        checkPrettyPrintEqual(s, s, v2);
    }

    public void testKwArgs() throws Exception {
        String s = "" + "def a(**kwargs):\n" + "    pass\n" + "";
        checkPrettyPrintEqual(s);
    }
    ...
    public void testDecorator2() throws Exception {
        String s = "" + "@decorator1(1,*args,**kwargs)\n" + "def m1():\n" + "    pass\n" + "";
        checkPrettyPrintEqual(s);
    }
    ...
    public void testStarArgs() throws Exception {
        String s = "" + "def recv(self,*args):\n" + "    pass\n" + "";
        checkPrettyPrintEqual(s);
    }

    public void testListComp() throws Exception {
        String s = "" + "print [x for x in tbinfo]\n" + "";
        checkPrettyPrintEqual(s);
    }

    public void testSub() throws Exception {
        String s = "" + "print tbinfo[-1]\n" + "";
        checkPrettyPrintEqual(s);
    }
    ...
    public void testPar2() throws Exception {
        String s = "" + "def log(self,message):\n" + "    sys.stderr.write('log: %s' % str(message))\n" + "";
        checkPrettyPrintEqual(s);
    }

    public void testPar() throws Exception {
        String s = "" + "print (not connected)\n" + "";
        String v2 = "" + "print not connected\n" + "";
        checkPrettyPrintEqual(s, s, v2);
    }
    ...
    public void testReturn2() throws Exception {
        String s = "" + "def writable():\n" + "    return (not connected) or len(foo)\n" + "";
        String v2 = "" + "def writable():\n" + "    return not connected or len(foo)\n" + "";
        checkPrettyPrintEqual(s, s, v2);
    }

    public void testSubs() throws Exception {
        String s = "" + "print num_sent[:512]\n" + "";
        checkPrettyPrintEqual(s);
    }

    public void testNot() throws Exception {
        String s = "" + "def recv(self,buffer_size):\n" + "    data = self.socket.recv(buffer_size)\n"
                + "    if not data:\n" + "        pass\n" + "";
        checkPrettyPrintEqual(s);
    }

    public void testIfAnd() throws Exception {
        String s = "" + "if aaa and bbb:\n" + "    pass\n" + "";
        checkPrettyPrintEqual(s);
    }

    public void testAnd() throws Exception {
        String s = "" + "def listen(self,num):\n" + "    self.accepting = True\n"
    ...
    public void testImportAs() throws Exception {
        String s = "" + "import foo as bla\n" + "";
        checkPrettyPrintEqual(s);
    }

    public void testImportAs2() throws Exception {
        String s = "" + "from a import foo as bla\n" + "";
        checkPrettyPrintEqual(s);
    }

    public void testIf2() throws Exception {
        String s = "" + "def readwrite():\n" + "    if True:\n" + "        a.b()\n" + "    if False:\n"
                + "        pass\n" + "";
        checkPrettyPrintEqual(s);
    }
    ...
    public void testImport2() throws Exception {
        String s = "" + "import foo.bla#comment\n" + "";
        checkPrettyPrintEqual(s);
    }

    public void testImport3() throws Exception {
        String s = "" + "from foo.bla import bla1#comment\n" + "";
        checkPrettyPrintEqual(s);
    }

    public void testImport4() throws Exception {
        String s = "" + "from foo.bla import bla1\n" + "import foo\n" + "from bla import (a,b,c)\n";

        String v2 = "" + "from foo.bla import bla1\n" + "import foo\n" + "from bla import a,b,c\n";
        checkPrettyPrintEqual(s, s, v2);
    }
    ...
    public void testWhile2() throws Exception {
        String s = "" + "while ((a + 1 < 0)):#comment\n" + "    pass\n" + "";
        String v2 = "" + "while (a + 1 < 0):#comment\n" + "    pass\n" + "";
        checkPrettyPrintEqual(s, s, v2);
    }
    ...
    public void testCall2() throws Exception {
        String s = "" + "callIt(1#param1\n" + ")\n" + "";
        String v2 = "" + "callIt(1)#param1\n" + "";
        checkPrettyPrintEqual(s, s, v2);
    }
    ...
    public void testCall4() throws Throwable {
        final String s = "" + "callIt(a=2,*args,**kwargs)\n" + "";
        checkWithAllGrammars(new ICallback<Boolean, Integer>() {
    ...
    public void testFuncComment() throws Exception {
        ...
        String v3 = "" + "def foo():#comment0\n" + "    print 'foo'\n" + "";
        checkPrettyPrintEqual(s, s, s, v3);
    }

    public void testPrint() throws Exception {
        String s = "" + "print >> a,'foo'\n" + "";
        checkPrettyPrintEqual(s);
    }

    public void testPrintComment() throws Exception {
        String s = "" + "def test():#comm1\n" + "    print >> (a,#comm2\n" + "        'foo')#comm3\n" + "";
        checkPrettyPrintEqual(s);
    }
    ...
    public void testAttr4() throws Exception {
        String s = "" + "hub.fun#comment\n" + "";
        checkPrettyPrintEqual(s);
    }

    public void testAttrCall() throws Exception {
        String s = "" + "print a.d().e(1 + 2)\n" + "";
        checkPrettyPrintEqual(s);
    }
    ...
    public void testDefaults() throws Exception {
        String s = "" + "def defaults(hi=None):\n" + "    if False:\n" + "        pass\n" + "";
        checkPrettyPrintEqual(s);

    }

    public void testDefaults2() throws Exception {
        String s = "" + "def defaults(a,x,lo=foo,hi=None):\n" + "    if hi is None:\n" + "        hi = a\n" + "";
        checkPrettyPrintEqual(s);
    ...
    public void testCommentAndIf() throws Throwable {
        final String s = "" + "def initiate_send():\n" + "    if 10:\n" + "        # try to send the buffer\n"
                + "        try:\n" + "            num_sent = 10\n" + "        except:\n" + "            pass\n" + "";

        final String v3 = "" + "def initiate_send():\n" + "    if 10:# try to send the buffer\n" + "        try:\n"
                + "            num_sent = 10\n" + "        except:\n" + "            pass\n" + "";
        checkWithAllGrammars(new ICallback<Boolean, Integer>() {
    ...
    public void testNoComments2() throws Exception {
        ...
        String s = "" + "class Class1(obj1, obj2):\n" + "    def met1(self, a, b):\n" + "        pass\n" + "";
        checkPrettyPrintEqual(s);
    }
    ...
    public void testComments2() throws Throwable {
        final String s = "" + "class Foo(object):#test comment\n" + "    def m1(self,a,#c1\n" + "        b):#c2\n"
                + "        pass\n" + "";
        checkWithAllGrammars(new ICallback<Boolean, Integer>() {
    ...
    public void testVarious2() throws Throwable {
        final String s = "" + "if self._file.getname() != 'FORM':\n"
    ...
    public void testVarious3() throws Throwable {
        final String s = "" + "def writeframes(self, data):\n" + "    self.writeframesraw(data)\n"
                + "    if self._nframeswritten != self._nframes or \\\n"
                + "          self._datalength != self._datawritten:\n" + "        self._patchheader()\n" + "";
        final String expected = "" + "def writeframes(self,data):\n" + "    self.writeframesraw(data)\n"
    ...
    public void testVarious4() throws Throwable {
        final String s = "" + "if map:\n" + "    r = []; w = []; e = []\n" + "";
        final String expected = "" + "if map:\n" + "    r = []\n" + "    w = []\n" + "    e = []\n" + "";
        checkWithAllGrammars(new ICallback<Boolean, Integer>() {
    ...
    public void testVarious5() throws Throwable {
        final String s = "" + "imap[self._fileno] = self\n" + "";
        checkWithAllGrammars(new ICallback<Boolean, Integer>() {
    ...
    public void testVarious6() throws Throwable {
        final String s = "" + "def accept(self):\n" + "    try:\n" + "        conn,addr = self.socket.accept()\n"
                + "        return conn,addr\n" + "    except socket.error:\n" + "        pass\n" + "";
        checkWithAllGrammars(new ICallback<Boolean, Integer>() {
    ...
    public void testVarious7() throws Throwable {
        final String s = "" + "def deleteMe(self):\n" + "    index = (self.file,self.line)\n"
                + "    self.bpbynumber[self.number] = None# No longer in list\n"
                + "    self.bplist[index].remove(self)\n" + "";

        final String v2 = "" + "def deleteMe(self):\n" + "    index = self.file,self.line\n"
                + "    self.bpbynumber[self.number] = None# No longer in list\n"
                + "    self.bplist[index].remove(self)\n" + "";
        checkWithAllGrammars(new ICallback<Boolean, Integer>() {
    ...
    public void testVarious8() throws Throwable {
        final String s = "" + "month_abbr = _localized_month('%b')\n" + "# Constants for weekdays\n"
                + "(MONDAY,TUESDAY,WEDNESDAY,THURSDAY,FRIDAY,SATURDAY,SUNDAY) = range(7)\n" + "";

        final String v2 = "" + "month_abbr = _localized_month('%b')\n" + "# Constants for weekdays\n"
                + "MONDAY,TUESDAY,WEDNESDAY,THURSDAY,FRIDAY,SATURDAY,SUNDAY = range(7)\n" + "";

        final String v3 = "" + "month_abbr = _localized_month('%b')# Constants for weekdays\n"
                + "MONDAY,TUESDAY,WEDNESDAY,THURSDAY,FRIDAY,SATURDAY,SUNDAY = range(7)\n" + "";
        checkWithAllGrammars(new ICallback<Boolean, Integer>() {
    ...
    public void testVarious9() throws Throwable {
        final String s = "" + "def _ilog(x,M,L=8):\n" + "    y = x - M\n" + "    R = 0\n" + "    while (R <= L or \n"
                + "        R > L):\n" + "        y = call((M * y) << 1,\n" + "            M,K)\n" + "        R += 1\n"
                + "";

        final String v2 = "" + "def _ilog(x,M,L=8):\n" + "    y = x - M\n" + "    R = 0\n"
                + "    while R <= L or R > L:\n" + "        y = call((M * y) << 1,\n" + "            M,K)\n"
                + "        R += 1\n" + "";

        final String v3 = "" + "def _ilog(x,M,L=8):\n" + "    y = x - M\n" + "    R = 0\n"
                + "    while R <= L or R > L:\n" + "        y = call((M * y) << 1,M,K)\n" + "        R += 1\n" + "";
        checkWithAllGrammars(new ICallback<Boolean, Integer>() {
    ...
    public void testVarious10() throws Throwable {
        final String s = "" + "num_lines[side] += 1\n" + "";
        checkWithAllGrammars(new ICallback<Boolean, Integer>() {
    ...
    public void testVarious11() throws Throwable {
        final String s = "" + "self.ac_in_buffer = self.ac_in_buffer[index + terminator_len:]\n" + "";
        checkWithAllGrammars(new ICallback<Boolean, Integer>() {
    ...
    public void testVarious12() throws Throwable {
        final String s = "" + "def ismethoddescriptor(object):\n" + "    return (hasattr(object, \"__get__\")\n"
                + "            and not hasattr(object, \"__set__\")# else it's a data descriptor\n"
                + "            #comment\n" + "            and not ismethod(object)# mutual exclusion\n"
                + "            and not isfunction(object))\n" + "";

        final String expected = "" + "def ismethoddescriptor(object):\n"
    ...
    public void testVarious13() throws Throwable {
        final String s = "" + "def remove_folder(self,folder):\n"
                + "    path = os.path.join(self._path,'.' + folder)\n"
                + "    for entry in os.listdir(os.path.join(path,'new')) + \\\n"
                + "        os.listdir(os.path.join(path,'cur')):\n" + "        pass\n" + "";

        final String expected = "" + "def remove_folder(self,folder):\n"
                + "    path = os.path.join(self._path,'.' + folder)\n"
    ...
    public void testVarious14() throws Throwable {
        final String s = "" + "def retrfile(self, file, type):\n" + "    if type in ('A'): cmd = 'TYPE A'; isdir = 1\n"
                + "    else: cmd = 'TYPE B'; isdir = 0\n" + "";

        final String expected = "" + "def retrfile(self,file,type):\n" + "    if type in ('A'):\n"
                + "        cmd = 'TYPE A'\n" + "        isdir = 1\n" + "    else:\n" + "        cmd = 'TYPE B'\n"
                + "        isdir = 0\n" + "";
    ...
    public void testVarious15() throws Throwable {
        final String s = "" + "def visiblename(name, all=None):\n"
                + "    if name in ('__builtins__', '__doc__', '__file__', '__path__',\n"
                + "                '__module__', '__name__', '__slots__'): return 0\n"
                + "    # Private names are hidden, but special names are displayed.\n"
                + "    if name.startswith('__') and name.endswith('__'): return 1\n" + "";

        final String expected = "" + "def visiblename(name,all=None):\n"
                + "    if name in ('__builtins__','__doc__','__file__','__path__',\n"
    ...
    public void testVarious16() throws Throwable {
        final String s = "" + "def m(a,):pass;pass\n" + "";

        final String expected = "" + "def m(a,):\n" + "    pass\n" + "    pass\n" + "";

        final String v2 = "" + "def m(a):\n" + "    pass\n" + "    pass\n" + "";
    ...
    public void testVarious17() throws Throwable {
        final String s = "" + "def m(a,\n" + "    b,\n" + "    c=False,\n" + "    ):\n" + "    pass\n" + "";

        final String expected = "" + "def m(a,\n" + "    b,\n" + "    c=False,\n" + "    ):\n" + "    pass\n" + "";

        final String v2 = "" + "def m(a,\n" + "    b,\n" + "    c=False):\n" + "    pass\n" + "";
        final String v3 = "" + "def m(a,b,c=False):\n" + "    pass\n" + "";
    ...
    public void testVarious18() throws Throwable {
        final String s = "" + "def b32encode(s):\n" + "    parts.extend([_b32tab[c1 >> 11],         # bits 1 - 5\n"
                + "                  _b32tab[c3 & 0x1f],        # bits 36 - 40 (1 - 5)\n" + "                  ])\n"
                + "";

        final String expected = "" + "def b32encode(s):\n" + "    parts.extend([_b32tab[c1 >> 11],# bits 1 - 5\n"
                + "            _b32tab[c3 & 0x1f],# bits 36 - 40 (1 - 5)\n" + "            ])\n" + "";

        final String v2 = "" + "def b32encode(s):\n" + "    parts.extend([_b32tab[c1 >> 11],# bits 1 - 5\n"
                + "            _b32tab[c3 & 0x1f]])# bits 36 - 40 (1 - 5)\n" + "";
    ...
    public void testVarious19() throws Throwable {
        final String s = "" + "def m1():\n" + "    try: return int(v)\n" + "    except ValueError:\n"
                + "        try: return float(v)\n" + "        except ValueError: pass\n" + "";

        final String expected = "" + "def m1():\n" + "    try:\n" + "        return int(v)\n"
                + "    except ValueError:\n" + "        try:\n" + "            return float(v)\n"
                + "        except ValueError:\n" + "            pass\n" + "";
    ...
    public void testVarious20() throws Throwable {
        final String s = "" + "_b32rev = dict([(v, long(k)) for k, v in _b32alphabet.items()])\n" + "";

        final String expected = "" + "_b32rev = dict([(v,long(k)) for (k,v) in _b32alphabet.items()])\n" + "";
    ...
    public void testVarious23() throws Throwable {
        final String s = "" + "assert nr_junk_chars > 0,(\n" + "    'split_header_words bug: %s, %s, %s' % \n"
    ...
    public void testVarious25() throws Throwable {
        final String s = "" + "assert n in (2,3,4,5)\n" + "";
    ...
    public void testVarious26() throws Throwable {
        final String s = "" + "def handle(self,context,*args):\n"
                + "    return (0,(0,),'n')#Passed to something which uses a tuple.\n" + "";

        final String v2 = "" + "def handle(self,context,*args):\n"
                + "    return 0,(0,),'n'#Passed to something which uses a tuple.\n" + "";
    ...
    public void testVarious28() throws Throwable {
        final String s = "" + "assert False,(\"unknown outcome\",outcome)\n" + "";
    ...
    public void testVarious29() throws Throwable {
        final String s = "" + "assert 0,'Could not find method in self.functions and no '\\\n"
                + "'instance installed'\n" + "";
    ...
    public void testVarious33() throws Throwable {
        final String s = "" + "def method(f):\n" + "    if True:\n" + "        pass\n" + "\n" + "class Obj(object):\n"
                + "    __slots__ = (\n" + "        # comment1\n" + "        'name1',\n" + "        # comment2\n"
                + "        'name2',\n" + "    )\n" + "";

        final String expected = "" + "def method(f):\n" + "    if True:\n" + "        pass\n" + "class Obj(object):\n"
                + "    __slots__ = (\n" + "        # comment1\n" + "        'name1',\n" + "        # comment2\n"
                + "        'name2',\n" + "        )\n" + "";

        final String v2 = "" + "def method(f):\n" + "    if True:\n" + "        pass\n" + "class Obj(object):\n"
                + "    __slots__ = (# comment1\n" + "        'name1',\n" + "        # comment2\n"
                + "        'name2')\n" + "";

        final String v3 = "" + "def method(f):\n" + "    if True:\n" + "        pass\n" + "class Obj(object):\n"
                + "    __slots__ = (# comment1\n" + "        'name1',# comment2\n" + "        'name2')\n" + "";
    ...
    public void testVarious34() throws Throwable {
        ...
        final String v2 = "" + "def Method():\n" + "    try:\n" + "        pass\n" + "    except:\n"
                + "        if data:\n" + "            pass\n" + "        else:\n" + "            pass\n"
                + "        pass\n" + "#comment\n" + "";

        final String v3 = "" + "def Method():\n" + "    try:\n" + "        pass\n" + "    except:\n"
                + "        if data:\n" + "            pass\n" + "        else:\n" + "            pass\n"
                + "        pass#comment\n" + "";
    ...
    public void testPrintOnlyArgs() throws Throwable {
        final String s = "" + "def Method(a,b,c=10,d=20,*args,**kwargs):\n" + "    pass\n" + "";
    ...
    public void testPrintOnlyArgs2() throws Throwable {
        final String s = "" + "def Method((a, b), c):\n" + "    pass\n" + "";
    ...
    public void testPrintMultipleKwargsInClassDef() throws Throwable {
        final String s = "" + "class A(meta=B,foo=C):\n" + "    pass\n" + "";
