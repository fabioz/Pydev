...
public class PrettyPrinter30Test extends AbstractPrettyPrinterTestBase {
    ...
    public void testAnnotations3() throws Exception {
        String s = "" + "def seek(self,pos:int,whence:int,*args:list,foo:int=10,**kwargs:dict)->int:\n" + "    pass\n";
        checkPrettyPrintEqual(s);
    }

    public void testAnnotations4() throws Exception {
        String s = "" + "def seek(whence:int,*,foo:int=10):\n" + "    pass\n";
        checkPrettyPrintEqual(s);
    }

    public void testAnnotations5() throws Exception {
        String s = "" + "def seek(self,pos:int=None,whence:int=0)->int:\n" + "    pass\n";
        checkPrettyPrintEqual(s);
    }
    ...
    public void testMethodDef2() throws Exception {
        String s = "" + "def _set_stopinfo(stoplineno=-1):\n" + "    pass\n" + "";
        checkPrettyPrintEqual(s);
    }

    public void testMethodDef3() throws Exception {
        String s = "" + "def _set_stopinfo(lnum=[arg]):\n" + "    pass\n" + "";
        checkPrettyPrintEqual(s);
    }
    ...
    public void testComment() throws Exception {
        String s = "" + "def __enter__(self)->'IOBase':#That's a forward reference\n" + "    pass\n";
        checkPrettyPrintEqual(s);
    }

    public void testListComp() throws Exception {
        String s = "" + "lines = [line if isinstance(line,str) else str(line,coding) for line in lines]\n";
        checkPrettyPrintEqual(s);
    }

    public void testNewIf() throws Exception {
        String s = "" + "j = stop if (arg in gets) else start\n" + "";
    ...
    public void testOthers2() throws Throwable {
        final String s = "" + "def _format(node):\n" + "    rv = '%s(%s' % (node.__class__.__name__,', '.join((\n"
    ...
    public void testManyGlobals() throws Throwable {
        final String s = "" + "global logfp,log\n" + "";

        checkPrettyPrintEqual(s);
    }

    public void testVarious1() throws Throwable {
        final String s = "" + "def _incrementudc(self):\n" + "    \"Increment update counter.\"\"\"\n"
    ...
    public void testWith() throws Throwable {
        final String s = "" + "with open(cfile,'rb') as chandle,open('cc') as d:\n" + "    pass\n" + "";
        checkPrettyPrintEqual(s);
    }

    public void testTupleInDict() throws Throwable {
        final String s = "" + "NAME_MAPPING = {(1,2):(3,4)}\n" + "";
        checkPrettyPrintEqual(s);
    }
