/* Generated By:JJTree&JavaCC: Do not edit this line. PythonGrammar311.java */
...
public final class PythonGrammar311 extends AbstractPythonGrammar implements/*@bgen(jjtree)*/ IGrammar, IGrammar2, PythonGrammar311Constants {/*@bgen(jjtree)*/
  protected final AbstractJJTPythonGrammarState jjtree = createJJTPythonGrammarState(TreeBuilder311.class);
...
//             '*' test )
 ...
 /*@bgen(jjtree) Name */
  ...
  public PythonGrammar311TokenManager token_source;
  /** Current token. */
  public Token token;
  /** Next token. */
  public Token jj_nt;
  ...
  public PythonGrammar311(boolean generateTree, FastCharStream stream) {
    super(generateTree);
    builder = jjtree.builder;
    token_source = new PythonGrammar311TokenManager(stream);
    token = new Token();
    jj_ntk = -1;
    jj_gen = 0;
  ...
  public PythonGrammar311(boolean generateTree, PythonGrammar311TokenManager tm) {
    super(generateTree);
    builder = jjtree.builder;
    token_source = tm;
    token = new Token();
