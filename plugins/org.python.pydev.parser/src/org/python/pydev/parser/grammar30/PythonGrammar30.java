...
//atom_expr: [AWAIT] atom trailer*
  ...
  final public void consume_await() throws ParseException {
    switch ((jj_ntk==-1)?jj_ntk():jj_ntk) {
    case AWAIT:
...
// we also change the order as '=' is faster to match than comp_for
//
