...
public final class PrettyPrinterVisitorV2 extends PrettyPrinterUtilsV2 {
    ...
    public Object visitAssign(Assign node) throws Exception {
        ...
        com.aptana.shared_core.utils.Tuple<ILinePart, ILinePart> lowerAndHigher = null;
    ...
    public Object visitAugAssign(AugAssign node) throws Exception {
        ...
        com.aptana.shared_core.utils.Tuple<ILinePart, ILinePart> lowerAndHigerFound = this.doc.getLowerAndHigerFound(this.doc
                .popRecordChanges(id));
    ...
    public Object visitBoolOp(BoolOp node) throws Exception {
        ...
        for (int i = 0; i < node.values.length - 1; i++) {
            ...
            com.aptana.shared_core.utils.Tuple<ILinePart, ILinePart> lowerAndHigher = doc.getLowerAndHigerFound(changes);
    ...
    public Object visitCompare(Compare node) throws Exception {
        ...
        com.aptana.shared_core.utils.Tuple<ILinePart, ILinePart> lowerAndHigher = doc.getLowerAndHigerFound(recordChanges);
    ...
    public Object visitEllipsis(Ellipsis node) throws Exception {
        ...
        com.aptana.shared_core.utils.Tuple<ILinePart, ILinePart> lowerAndHigerFound = this.doc.getLowerAndHigerFound(changes);
    ...
    public Object visitRepr(Repr node) throws Exception {
        ...
        java.util.List<ILinePart> changes = doc.popRecordChanges(id);
        com.aptana.shared_core.utils.Tuple<ILinePart, ILinePart> lowerAndHigerFound = doc.getLowerAndHigerFound(changes);
    ...
    public Object visitAttribute(Attribute node) throws Exception {
        ...
        com.aptana.shared_core.utils.Tuple<ILinePart, ILinePart> lowerAndHigerFound = doc.getLowerAndHigerFound(recordChanges);
    ...
    public Object visitClassDef(ClassDef node) throws Exception {
        ...
        java.util.List<ILinePart> changes = this.doc.popRecordChanges(id);
        if (changes.size() > 0) {
            com.aptana.shared_core.utils.Tuple<ILinePart, ILinePart> found = this.doc.getLowerAndHigerFound(changes, true);
            if (found != null) {
