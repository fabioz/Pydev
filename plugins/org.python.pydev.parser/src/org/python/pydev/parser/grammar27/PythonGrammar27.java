...
public final class PythonGrammar27 extends AbstractPythonGrammar implements/*@bgen(jjtree)*/ IGrammar, PythonGrammar27Constants {/*@bgen(jjtree)*/
  protected JJTPythonGrammarState jjtree = new JJTPythonGrammarState(TreeBuilder27.class, this);
    ...
    try {
      ...
      case EQUAL:
        temporaryToken = jj_consume_token(EQUAL);
                                   this.prev.addSpecial(temporaryToken, true);
        test();
        break;
      default:
        jj_la1[11] = jj_gen;
...
//small_stmt: expr_stmt | print_stmt  | del_stmt | pass_stmt | flow_stmt | import_stmt | global_stmt | exec_stmt | assert_stmt
  final public void small_stmt() throws ParseException {
    ...
    case ASSERT:
      ...
      assert_stmt();
                                           addToPeek(temporaryToken, false);
      break;
    default:
      jj_la1[16] = jj_gen;
      jj_consume_token(-1);
  ...
  jjtreeOpenNodeScope(jjtn000);
    try {
      temporaryToken = jj_consume_token(DEL);
                         ...
                         jjtc000 = false;
                         jjtreeCloseNodeScope(jjtn000);
                        this.addToPeek(temporaryToken,false);
    } finally {
    if (jjtc000) {
      jjtree.closeNodeScope(jjtn000, true);
      jjtreeCloseNodeScope(jjtn000);
...
//raise_stmt: 'raise' [test [',' test [',' test]]]
  ...
  jjtreeOpenNodeScope(jjtn000);
    try {
   temporaryToken=createSpecialStr("raise");
  ...
  final public void import_stmt() throws ParseException {
    ...
    try {
      ...
      case IMPORT:
        ...
        break;
      case FROM:
         temporaryToken=createSpecialStr("from");
  ...
  final public void if_stmt() throws ParseException {
    ...
    try {
      ...
      case ELSE:
        ...
        suite();
                                                   addToPeek(elseToks[0], false, Suite.class);addToPeek(elseToks[1], false, Suite.class);
        break;
      default:
        jj_la1[59] = jj_gen;
        ;
...
//with_item: test ['as' expr]
  ...
  SimpleNode jjtn000 = jjtree.builder.openNode( JJTWITH_ITEM);
  boolean jjtc000 = true;
  jjtree.openNodeScope(jjtn000);
  jjtreeOpenNodeScope(jjtn000);
    try {
...
//argument: [test '='] test     # Really [keyword '='] test
 ...
 /*@bgen(jjtree) Name */
  ...
  public PythonGrammar27(CharStream stream) {
  ...
  public PythonGrammar27(PythonGrammar27TokenManager tm) {
    token_source = tm;
    token = new Token();
    jj_ntk = -1;
    jj_gen = 0;
  ...
  /** Reinitialise. */
  public void ReInit(PythonGrammar27TokenManager tm) {
    token_source = tm;
    token = new Token();
    jj_ntk = -1;
    jjtree.reset();
