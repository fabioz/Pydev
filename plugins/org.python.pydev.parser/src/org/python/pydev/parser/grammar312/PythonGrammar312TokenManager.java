/* Generated By:JJTree&JavaCC: Do not edit this line. PythonGrammar312TokenManager.java */
...
/** Token Manager. */
@SuppressWarnings("unused") public final class PythonGrammar312TokenManager extends AbstractTokenManager implements PythonGrammar312Constants
{
    protected Class<?> getConstantsClass(){
        return PythonGrammar312Constants.class;
    }
...
/** Constructor. */
public PythonGrammar312TokenManager(FastCharStream stream){
   input_stream = stream;
}

/** Constructor. */
public PythonGrammar312TokenManager(FastCharStream stream, int lexState){
   this(stream);
   SwitchTo(lexState);
}
