...
public class RenameLocalVariableRefactoringTest extends RefactoringLocalTestBase {
    ...
    public void testRenameImportLocally4() throws Exception {
        String str = "" + "from extendable.constants import %s\n" + "def run():\n" + "    print %s\n"
                + "    #comment %s\n" + "    'string %s'" + "\n" + "";
        int line = 2;
        int col = 11;
    ...
    public void testRenameMethodImportLocally() throws Exception {
        String str = "" + "from testAssist.assist.ExistingClass import %s\n" + "def run():\n" + "    print %s\n" + "\n"
                + "";
        int line = 2;
        int col = 11;
    ...
    public void testRenameMethodImportLocally2() throws Exception {
        String str = "" + "from testAssist.assist import ExistingClass\n" + "def run():\n"
    ...
    public void testRenameClassImportLocally() throws Exception {
        String str = "" + "from testAssist.assist import %s\n" + "def run():\n" + "    print %s\n" + "\n" + "";
        int line = 2;
        int col = 11;
    ...
    public void testRenameParam2() throws Exception {
        String str = "" + "class DefaultProcessFactory(object):\n" + "    \n" + "    def _DoCreateIt(self, %s):\n"
                + "        pass\n" + "        \n" + "    def CreateIt(self, a):\n"
