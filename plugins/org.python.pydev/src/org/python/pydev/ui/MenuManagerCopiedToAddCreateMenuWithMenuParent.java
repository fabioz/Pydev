 ...
 * </p>
 * 
 * This class is a copy of the MenuManager just to add the method
 * org.python.pydev.ui.MenuManagerCopiedToAddCreateMenuWithMenuParent.createContextMenu(Menu) 
 * because the default only accepted a constructor with a control and overriding proved to be bad because
 * the needed methods are private.
 */
public class MenuManagerCopiedToAddCreateMenuWithMenuParent extends ContributionManager implements IMenuManager {
     ...
     */
    public MenuManagerCopiedToAddCreateMenuWithMenuParent() {
        this(null, null, null);
    }
     ...
     */
    public MenuManagerCopiedToAddCreateMenuWithMenuParent(String text) {
        this(text, null, null);
    }
     ...
     */
    public MenuManagerCopiedToAddCreateMenuWithMenuParent(String text, String id) {
        this(text, null, id);
    }
     ...
     * @since 3.4
     */
    public MenuManagerCopiedToAddCreateMenuWithMenuParent(String text, ImageDescriptor image, String id) {
        this.menuText = text;
        this.image = image;
        this.id = id;
    }
