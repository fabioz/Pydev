...
abstract class PyContainerFormatterAction extends PyContainerAction {
    ...
    protected void afterRun(int formatted) {
        openFiles = null;
        formatter = null;
        MessageDialog.openInformation(null, "Files "+verbPassed, org.python.pydev.shared_core.string.StringUtils.format("%s %s files.", 
                    ...
                    if (name != null) {
                        ...
                        if (PythonPathHelper.isValidSourceFile(name)) {
                            ...
                            try {
                                ...
                                Log.log(IStatus.ERROR, "Could not "+verbPresentMsg+" file: " + name + " (invalid syntax).",
                                        e);
                            }
                            formatted += 1;
                            if (isOpenedFile) {
