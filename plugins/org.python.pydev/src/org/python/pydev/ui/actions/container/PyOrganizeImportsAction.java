 ...
 */
public class PyOrganizeImportsAction extends PyContainerAction {
    ...
    protected boolean confirmRun() {
        return MessageDialog
                .openConfirm(
                        null,
                        "Confirm organize imports",
                        "Are you sure that you want to recursively organize imports in the python files from the selected folder(s)?\n"
                                + "\n"
