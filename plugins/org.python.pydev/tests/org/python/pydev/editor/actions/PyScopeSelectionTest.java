...
public class PyScopeSelectionTest extends TestCase {
    ...
    public void check(String string, int initialOffset, int initialLenOffset, int finalOffset, int finalLenOffset) {
        ...
        ICoreTextSelection selection = new CoreTextSelection(doc, initialOffset, initialLenOffset);

        ICoreTextSelection newSelection = scopeSelection.getNewSelection(doc, selection, new PythonPairMatcher(),
                new ScopesParser());
