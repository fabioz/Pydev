...
public class Flake8AnalysisTest extends TestCase {
    ...
    * @param violation_code flake8 violation code
    * @param message flake8 descriptive message
    * @param actualMarkers markers
    */
    private void assertMarkerEquals(int line, int column, String violation_code, String message) {
        ...
        assertEquals(index + ": MarkerInfo message_id", violation_code,
    ...
    public void testMarkersMessage()
        ...
        assertMarkerEquals(0, 0, "W292", "no newline at end of file");
    }
    ...
    public void testMarkersMessage1() {
        ...
        assertMarkerEquals(0, 0, "E902", "IndentationError: unindent does not match any outer indentation level");
        assertMarkerEquals(1, 79, "E501", "line too long (80 > 79 characters)");
        assertMarkerEquals(3, 4, "E113", "unexpected indentation");
        assertMarkerEquals(4, 0, "E302", "expected 2 blank lines, found 0");
        assertMarkerEquals(5, 8, "E117", "over-indented");
    }
