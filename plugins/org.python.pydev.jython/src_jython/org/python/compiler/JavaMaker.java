...
public class JavaMaker extends ProxyMaker implements ClassConstants {
    ...
    public void addConstructor(String name, Class[] parameters, Class ret, String sig, int access) throws Exception {
        ...
        int initProxy = code.pool.Methodref(classfile.name, "__initProxy__", "([Ljava/lang/Object;)V");
    ...
    public void addProxy() throws Exception {
        ...
        int initProxy = code.pool.Methodref("org/python/core/Py", "initProxy", "(" + $pyProxy + $str + $str + $objArr
                + $strArr + $strArr + "Z)V");
    ...
    */
    ...
    public void addMain() throws Exception {
        Code code = classfile.addMethod("main", "(" + $str + ")V", ClassFile.PUBLIC | ClassFile.STATIC);
        ...
        int runMain = code.pool.Methodref("org/python/core/Py", "runMain", "(" + $clss + $strArr + $strArr + $strArr
                + "Z)V");
