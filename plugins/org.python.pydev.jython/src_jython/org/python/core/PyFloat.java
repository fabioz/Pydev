...
public class PyFloat extends PyObject {
    ...
    public static void typeSetup(PyObject dict, PyType.Newstyle marker) {
        ...
        dict.__setitem__("__float__", new PyMethodDescr("__float__", PyFloat.class, 0, 0, new exposed___float__(null,
                null)));
        ...
        dict.__setitem__("__long__", new PyMethodDescr("__long__", PyFloat.class, 0, 0,
                new exposed___long__(null, null)));
        ...
        dict.__setitem__("__divmod__", new PyMethodDescr("__divmod__", PyFloat.class, 1, 1, new exposed___divmod__(
                null, null)));
        ...
        dict.__setitem__("__floordiv__", new PyMethodDescr("__floordiv__", PyFloat.class, 1, 1,
        ...
        dict.__setitem__("__radd__", new PyMethodDescr("__radd__", PyFloat.class, 1, 1,
                new exposed___radd__(null, null)));
        ...
        dict.__setitem__("__rdiv__", new PyMethodDescr("__rdiv__", PyFloat.class, 1, 1,
                new exposed___rdiv__(null, null)));
        ...
        dict.__setitem__("__rfloordiv__", new PyMethodDescr("__rfloordiv__", PyFloat.class, 1, 1,
        ...
        dict.__setitem__("__rmod__", new PyMethodDescr("__rmod__", PyFloat.class, 1, 1,
                new exposed___rmod__(null, null)));
        ...
        dict.__setitem__("__rmul__", new PyMethodDescr("__rmul__", PyFloat.class, 1, 1,
        ...
        dict.__setitem__("__rsub__", new PyMethodDescr("__rsub__", PyFloat.class, 1, 1,
                new exposed___rsub__(null, null)));
        ...
        dict.__setitem__("__rtruediv__", new PyMethodDescr("__rtruediv__", PyFloat.class, 1, 1,
        ...
        dict.__setitem__("__truediv__", new PyMethodDescr("__truediv__", PyFloat.class, 1, 1, new exposed___truediv__(
                null, null)));
        ...
        dict.__setitem__("__rdivmod__", new PyMethodDescr("__rdivmod__", PyFloat.class, 1, 1, new exposed___rdivmod__(
                null, null)));
        ...
        dict.__setitem__("__rpow__", new PyMethodDescr("__rpow__", PyFloat.class, 1, 1,
                new exposed___rpow__(null, null)));
        class exposed___cmp__ extends PyBuiltinMethodNarrow {
            ...
            public PyObject __call__(PyObject arg0) {
                ...
                if (ret == -2) {
                    throw Py.TypeError("float" + ".__cmp__(x,y) requires y to be '" + "float" + "', not a '"
        ...
        dict.__setitem__("__nonzero__", new PyMethodDescr("__nonzero__", PyFloat.class, 0, 0, new exposed___nonzero__(
                null, null)));
        ...
        dict.__setitem__("__repr__", new PyMethodDescr("__repr__", PyFloat.class, 0, 0,
        ...
        dict.__setitem__("__hash__", new PyMethodDescr("__hash__", PyFloat.class, 0, 0,
    ...
    final PyObject float___divmod__(PyObject right) {
        ...
        return new PyTuple(new PyObject[] { new PyFloat(z), new PyFloat(value - z * rightv) });
    }
    ...
    public PyObject __rdivmod__(PyObject left) {
        ...
        return new PyTuple(new PyObject[] { new PyFloat(z), new PyFloat(leftv - z * value) });
    }
