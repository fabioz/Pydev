...
final class BuiltinFunctions extends PyBuiltinFunctionSet {
    ...
    public PyObject __call__(PyObject arg1, PyObject arg2) {
        switch (this.index) {
            ...
            case 22:
                return Py.newBoolean(__builtin__.hasattr(arg1,
                        asString(arg2, "hasattr(): attribute name must be string")));
            case 26:
    ...
    public PyObject fancyCall(PyObject[] args) {
        switch (this.index) {
            case 44:
                ...
                return __builtin__.compile(args[0].toString(), args[1].toString(), args[2].toString(), flags,
                        dont_inherit);
            case 29:
