...
public abstract class PyBuiltinFunction extends PyObject implements PyType.Newstyle {
    ...
    public static void typeSetup(PyObject dict, PyType.Newstyle marker) {
        dict.__setitem__("__name__", new PyGetSetDescr("__name__", PyBuiltinFunction.class, "fastGetName", null));
        dict.__setitem__("__self__", new PyGetSetDescr("__self__", PyBuiltinFunction.class, "getSelf", null));
        dict.__setitem__("__doc__", new PyGetSetDescr("__doc__", PyBuiltinFunction.class, "fastGetDoc", null));
        dict.__setitem__("__call__", new PyGetSetDescr("__call__", PyBuiltinFunction.class, "makeCall", null));
    }
    ...
    public String toString() {
        ...
        if (self == null)
            ...
            return "<built-in method " + info.getName() + " of " + typename + " object>";
        }
    }
