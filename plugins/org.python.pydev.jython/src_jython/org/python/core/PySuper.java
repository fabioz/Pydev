...
public class PySuper extends PyObject implements PyType.Newstyle {
    ...
    public static void typeSetup(PyObject dict, PyType.Newstyle marker) {
        ...
        dict.__setitem__("__getattribute__", new PyMethodDescr("__getattribute__", PySuper.class, 1, 1,
        ...
        dict.__setitem__("__init__", new PyMethodDescr("__init__", PySuper.class, -1, -1, new exposed___init__(null,
                null)));
    ...
    public void super_init(PyObject[] args, String[] keywords) {
        if (keywords.length != 0 || !PyBuiltinFunction.DefaultInfo.check(args.length, 1, 2)) {
            throw PyBuiltinFunction.DefaultInfo.unexpectedCall(args.length, keywords.length != 0, "super", 1, 2);
        }
