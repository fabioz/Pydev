...
public class types implements ClassDictInit {
    public static PyString __doc__ = new PyString("Define names for all type symbols known in the standard "
    ...
    public static void classDictInit(PyObject dict) {
        ...
        dict.__setitem__("StringTypes",
                new PyTuple(new PyObject[] { PyType.fromClass(PyString.class), PyType.fromClass(PyUnicode.class) }));
    }
}
