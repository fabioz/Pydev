...
public class newmodule {
    ...
    public static PyMethod instancemethod(PyObject func, PyObject instance, PyClass clss) {
    ...
    public static PyFunction function(PyCode code, PyObject globals, String name, PyObject[] argdefs) {
    ...
    public static PyFunction function(PyCode code, PyObject globals, String name, PyObject[] argdefs, PyObject[] closure) {
