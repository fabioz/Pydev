...
public class synchronize {
    ...
    public static PyObject apply_synchronized(PyObject sync_object, PyObject callable, PyObject args) {
        synchronized (_getSync(sync_object)) {
            return __builtin__.apply(callable, args);
        }
    }

    public static PyObject apply_synchronized(PyObject sync_object, PyObject callable, PyObject args, PyDictionary kws) {
        synchronized (_getSync(sync_object)) {
