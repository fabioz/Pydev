...
public class PyImmutableSet extends BaseSet {
    ...
    public static void typeSetup(PyObject dict, PyType.Newstyle marker) {
        ...
        dict.__setitem__("__ne__", new PyMethodDescr("__ne__", PyImmutableSet.class, 1, 1, new exposed___ne__(null,
                null)));
        ...
        dict.__setitem__("__eq__", new PyMethodDescr("__eq__", PyImmutableSet.class, 1, 1, new exposed___eq__(null,
                null)));
        ...
        dict.__setitem__("__or__", new PyMethodDescr("__or__", PyImmutableSet.class, 1, 1, new exposed___or__(null,
                null)));
        ...
        dict.__setitem__("__xor__", new PyMethodDescr("__xor__", PyImmutableSet.class, 1, 1, new exposed___xor__(null,
                null)));
        ...
        dict.__setitem__("__sub__", new PyMethodDescr("__sub__", PyImmutableSet.class, 1, 1, new exposed___sub__(null,
                null)));
        ...
        dict.__setitem__("__and__", new PyMethodDescr("__and__", PyImmutableSet.class, 1, 1, new exposed___and__(null,
                null)));
        ...
        dict.__setitem__("__gt__", new PyMethodDescr("__gt__", PyImmutableSet.class, 1, 1, new exposed___gt__(null,
                null)));
        ...
        dict.__setitem__("__ge__", new PyMethodDescr("__ge__", PyImmutableSet.class, 1, 1, new exposed___ge__(null,
                null)));
        ...
        dict.__setitem__("__le__", new PyMethodDescr("__le__", PyImmutableSet.class, 1, 1, new exposed___le__(null,
                null)));
        ...
        dict.__setitem__("__lt__", new PyMethodDescr("__lt__", PyImmutableSet.class, 1, 1, new exposed___lt__(null,
                null)));
        ...
        dict.__setitem__("__contains__", new PyMethodDescr("__contains__", PyImmutableSet.class, 1, 1,
        ...
        dict.__setitem__("__deepcopy__", new PyMethodDescr("__deepcopy__", PyImmutableSet.class, 1, 1,
                new exposed___deepcopy__(null, null)));
        ...
        dict.__setitem__("__nonzero__", new PyMethodDescr("__nonzero__", PyImmutableSet.class, 0, 0,
        ...
        dict.__setitem__("difference", new PyMethodDescr("difference", PyImmutableSet.class, 1, 1,
                new exposed_difference(null, null)));
        ...
        dict.__setitem__("symmetric_difference", new PyMethodDescr("symmetric_difference", PyImmutableSet.class, 1, 1,
                new exposed_symmetric_difference(null, null)));
        ...
        dict.__setitem__("intersection", new PyMethodDescr("intersection", PyImmutableSet.class, 1, 1,
                new exposed_intersection(null, null)));
        ...
        dict.__setitem__("issubset", new PyMethodDescr("issubset", PyImmutableSet.class, 1, 1, new exposed_issubset(
                null, null)));
        ...
        dict.__setitem__("issuperset", new PyMethodDescr("issuperset", PyImmutableSet.class, 1, 1,
                new exposed_issuperset(null, null)));
        ...
        dict.__setitem__("__len__", new PyMethodDescr("__len__", PyImmutableSet.class, 0, 0, new exposed___len__(null,
                null)));
        ...
        dict.__setitem__("__reduce__", new PyMethodDescr("__reduce__", PyImmutableSet.class, 0, 0,
                new exposed___reduce__(null, null)));
        ...
        dict.__setitem__("__hash__", new PyMethodDescr("__hash__", PyImmutableSet.class, 0, 0, new exposed___hash__(
                null, null)));
