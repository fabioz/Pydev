...
public class FastPartitioner extends org.eclipse.jface.text.rules.FastPartitioner {
...
// Code below for testing (copy of FastPartitioner)
...
//    public final IPartitionTokenScanner fScanner;
...
//
//            System.out.println("Set partial range offset: " + reparseStart + " len: "
//                    + (fDocument.getLength() - reparseStart) + " partition start: " + partitionStart);
...
//                if (!isSupportedContentType(contentType)) {
//                    token = fScanner.nextToken();
//                    System.out.println("Skip: offset: " + fScanner.getTokenOffset() + " len:"
//                            + fScanner.getTokenLength() + " content: " + contentType);
//                    continue;
//                }
//
//                int start = fScanner.getTokenOffset();
//                int length = fScanner.getTokenLength();
//                System.out.println("Match: offset: " + fScanner.getTokenOffset() + " len:"
//                        + fScanner.getTokenLength() + " content: " + contentType);
//
