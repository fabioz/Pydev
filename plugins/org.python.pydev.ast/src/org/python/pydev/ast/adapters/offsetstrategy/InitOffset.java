...
package org.python.pydev.ast.adapters.offsetstrategy;

import org.eclipse.jface.text.IDocument;
import org.python.pydev.ast.adapters.IASTNodeAdapter;
import org.python.pydev.ast.adapters.visitors.LastLineVisitor;
        ...
        if (nodeHelper.isClassDef(node)) {
            ...
            for (stmtType statement : classNode.body) {
                if (nodeHelper.isInit(statement)) {
                    ...
                    LastLineVisitor visitor = new LastLineVisitor();
                    try {
                        lastStmt.accept(visitor);
                    } catch (Exception e) {
