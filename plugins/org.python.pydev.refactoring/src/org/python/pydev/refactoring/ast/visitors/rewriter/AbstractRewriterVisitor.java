...
public abstract class AbstractRewriterVisitor extends VisitorBase {
	...
	public AbstractRewriterVisitor(OutputStream out, AdapterPrefs adapterPrefs) {
		this(new SourcePrinter(new PrintWriter(out, true), adapterPrefs));
	}
	...
	public AbstractRewriterVisitor(Writer out, AdapterPrefs adapterPrefs) {
		this(new SourcePrinter(new PrintWriter(out), adapterPrefs));
	}
