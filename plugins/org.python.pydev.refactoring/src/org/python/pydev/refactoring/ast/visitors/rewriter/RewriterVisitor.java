...
//    }
    ...
    public static String createSourceFromAST(SimpleNode root, boolean ignoreComments, String newLineDelim) {
        ...
        PrettyPrinterPrefsV2 prettyPrinterPrefs = new PrettyPrinterPrefsV2(newLineDelim, indentPrefs.getIndentationString());
        ...
        prettyPrinterPrefs.setSpacesAfterColon(1);
