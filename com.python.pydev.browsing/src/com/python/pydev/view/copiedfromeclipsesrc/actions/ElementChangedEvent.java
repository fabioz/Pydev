...
import com.python.pydev.view.copiedfromeclipsesrc.actions.IElementChangedListener;

import com.python.pydev.view.copiedfromeclipsesrc.IJavaElementDelta;
...
public class ElementChangedEvent extends EventObject {
	 ...
	 */
	public ElementChangedEvent(IResourceDelta delta, int type) {
		super(delta);
		this.type = type;
	}
	/**
